...
#ifndef REPROMPI_BENCH_SYNC_PROCESS_SYNC_REPROMPI_COLLECTIVES_H_
#define REPROMPI_BENCH_SYNC_PROCESS_SYNC_REPROMPI_COLLECTIVES_H_
...
#endif /* REPROMPI_BENCH_SYNC_PROCESS_SYNC_REPROMPI_COLLECTIVES_H_ */
